...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Teams] ([teamId], [TeamName], [totPoints], [teamColor])
        SELECT   [teamId],
                 [TeamName],
                 [totPoints],
                 [teamColor]
...
ALTER TABLE [dbo].[DriverTeam] WITH NOCHECK
    ADD CONSTRAINT [FK_DriverTeam_Teams_Team] FOREIGN KEY ([Team]) REFERENCES [dbo].[Teams] ([teamId]);

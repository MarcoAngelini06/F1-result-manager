...
GO
/*
The type for column prezzo in table [dbo].[servizi] is currently  NTEXT NOT NULL but is being changed to  INT NOT NULL. There is no implicit or explicit conversion.
*/
GO
